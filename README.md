...
```csharp
!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Container.puml
```
...
!define DEVICONS https://ghproxy.com/https://raw.githubusercontent.com/tupadr3/plantuml-icon-font-sprites/master/devicons
!define FONTAWESOME https://ghproxy.com/https://raw.githubusercontent.com/tupadr3/plantuml-icon-font-sprites/master/font-awesome-5
...
Person(admin, "Administrator", $sprite="person2", $link="https://github.com/fakeYanss/C4-PlantUML/blob/master/LayoutOptions.md#hide_person_sprite-or-show_person_spritesprite")
System_Boundary(c1, "Sample System", $link="https://github.com/fakeYanss/C4-PlantUML") {
    Container(web_app, "Web Application", "C#, ASP.NET Core 2.1 MVC", $descr="Allows users to compare multiple Twitter timelines", $link="https://github.com/fakeYanss/C4-PlantUML/blob/master/LayoutOptions.md")
}
System(twitter, "Twitter", $link="https://github.com/fakeYanss/C4-PlantUML")
...
* System Context & System Landscape diagrams
  * Import: `!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Context.puml`
  * Macros: 
    ...
    * `System_Boundary` 
* Container diagram
  * Import: `!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Container.puml`
  * Additional Macros: 
...
* Component diagram
  * Import: `!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Component.puml`
  * Additional Macros: 
    ...
    * `ComponentQueue_Ext`
* Dynamic diagram
  * Import: `!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Dynamic.puml`
  * Additional Macros: 
...
* Deployment diagram
  * Import: `!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Deployment.puml`
  * Additional Macros: 
...
```csharp
@startuml
!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Context.puml
...
```csharp
@startuml
!include https://ghproxy.com/https://raw.githubusercontent.com/fakeYanss/C4-PlantUML/master/C4_Deployment.puml
